/**
 * angular-growl-v2 - v0.7.9 - 2016-11-22
...
angular.module('angular-growl').provider('growl', function () {
  ...
  var _ttl = {
      ...
      warning: null,
      info: null
    }, _messagesKey = 'messages', _messageTextKey = 'text', _messageTitleKey = 'title', _messageSeverityKey = 'severity', _messageTTLKey = 'ttl', _onlyUniqueMessages = true, _messageVariableKey = 'variables', _messageReferenceIdKey = 'referenceId', _referenceId = 0, _inline = false, _position = 'top-right', _disableCloseButton = false, _clickToClose = true, _disableIcons = false, _reverseOrder = false, _disableCountDown = false, _translateMessages = true;
